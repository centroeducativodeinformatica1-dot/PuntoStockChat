const PATHS = {
  ...
  widget:      <><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></>,
  send:        <><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></>,
  logOut:      <><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></>,
  x:           <><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></>,
  plus:        <><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></>,
  trash:       <><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 0-2-2L5 6"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></>,
  ...
  nodes:       <><circle cx="12" cy="5" r="3"/><circle cx="5" cy="19" r="3"/><circle cx="19" cy="19" r="3"/><line x1="12" y1="8" x2="5" y2="16"/><line x1="12" y1="8" x2="19" y2="16"/></>,
  zoomIn:      <><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="11" y1="8" x2="11" y2="14"/><line x1="8" y1="11" x2="14" y2="11"/></>,
  zoomOut:     <><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="8" y1="11" x2="14" y2="11"/></>,
  reset:       <><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-3.53"/></>,
...
export const Icon = ({ n, size = 16, color = 'currentColor', style: s = {} }) => (
...
export const GoogleIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" style={{ flexShrink: 0 }}>
    <path d="M20.3 12.2c0-.6-.1-1.2-.2-1.8H12v3.4h4.7c-.2 1-.8 1.9-1.7 2.5v2h2.7c1.6-1.5 2.6-3.7 2.6-6.1z" fill="#4285F4"/>
    <path d="M12 21c2.4 0 4.4-.8 5.9-2.1l-2.7-2c-.9.6-2 .9-3.2.9-2.4 0-4.5-1.6-5.2-3.9H4v2.1C5.5 19.2 8.6 21 12 21z" fill="#34A853"/>
    <path d="M6.8 13.9c-.2-.6-.3-1.2-.3-1.9s.1-1.3.3-1.9V8H4a9 9 0 0 0 0 8l2.8-2.1z" fill="#FBBC05"/>
    <path d="M12 6.6c1.4 0 2.6.5 3.5 1.3l2.6-2.6C16.4 3.8 14.4 3 12 3 8.6 3 5.5 4.8 4 8l2.8 2.1C7.5 8.2 9.6 6.6 12 6.6z" fill="#EA4335"/>
  </svg>
)
